...
const LoginPage = () => {
  ...
  const handleSubmit = async () => {
    ...
    const res = await StudentServices.login(userDetails);
  ...
  return (
    <>
      <div className="container relative h-[100vh] flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0">
        <div className="relative hidden h-full max-h-full overflow-hidden flex-col bg-muted text-white lg:flex dark:border-r">
          <img
